...
public class FileOperation {
    ...
    /**
     * <p> save code object to file json</p>
    ...
    /**
     * @param path string of path of file xml to parse code
     * @return List of code which only name and version
     */
    public List<Code> parseXmlFile(String path) {
    ...
    /**
     * <p> parse Code from Json to Code object</p>
     * @param path string of path of file to parse code
     * @return Code object
     */
    public Code parseCodeJsonFile(String path) {
        ...
        for(int i = 0 ; i < jsonArray.length() ; i++)
            try { code.addStringToSet(jsonArray.getString(i));
